...
import { SplitPaneGeometry, SplitTabComponent } from './splitTab.component'
...
@Component({
    ...
    template: `
    <div *ngIf='tab.customTitle && tab.customTitleVisible' class='custom-name'>{{tab.customTitle}}</div>
