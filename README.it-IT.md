...
* Client SSH integrato con gestore delle connessioni
...
* Client SSH e SFTP disponibile come [web app](https://tabby.sh/app) (anche [self-hosted](https://github.com/Eugeny/tabby-web)).
