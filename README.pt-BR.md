...
* Cliente e gerenciador de conexões SSH integrado
...
* SSH e SFTP disponível como [aplicação web](https://tabby.sh/app) (também em [hospedagem local](https://github.com/Eugeny/tabby-web)).
