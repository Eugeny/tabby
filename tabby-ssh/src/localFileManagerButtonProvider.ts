...
import { ToolbarButtonProvider, ToolbarButton, AppService, TabsService, SplitTabComponent, BaseTabComponent } from 'tabby-core'
import { LocalFileManagerTabComponent } from './components/localFileManagerTab.component'
import { SSHTabComponent } from './components/sshTab.component'
import * as fs from 'fs'

@Injectable()
export class LocalFileManagerButtonProvider extends ToolbarButtonProvider {
    ...
    private async openInPlace (tab: BaseTabComponent|null): Promise<void> {
        ...
        if (relative instanceof SSHTabComponent) {
            return
        }
