...
* Встроенный SSH-клиент и менеджер подключений;
...
* SSH- и SFTP-клиент доступен как [веб-приложение](https://tabby.sh/app) (также для [самостоятелньного хостинга](https://github.com/Eugeny/tabby-web)).
